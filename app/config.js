...
const ANI_VERIFICATION_TOKEN = "EAAIL6dc0iLsBAOLkRWhYYqkfgZBrl38viM5UImPsNdpOBxTeZAF45haxoJK3JZCJ2QZAVhWmFmQsZCWhcqcRStr2UM2QoCfsl78F0XJDBtv4XZAPaPWROs6w9Ld0vVZCVcj5tFZA2BBo977R3o0JXOF85iZAQejIntjzZClZCulSyflkwZDZD";
const ANI_MESSENGER_URL = "http://m.me/519450361582633";
...
const ANI_FACEBOOK_PAGE_URL = "https://www.facebook.com/Anirudh-Test-519450361582633/";
const ANI_MONGODB_URI = TEST_MONGODB_URI;
const ANI_LUIS_ID = TEST_LUIS_ID;
const ANI_LUIS_SUBSCRIPTION_KEY = TEST_LUIS_SUBSCRIPTION_KEY;
const ANI_ROOT_URL = "https://a3d9383a.ngrok.io";
const ANI_TWILIO_ACCOUNT_SID = TEST_TWILIO_ACCOUNT_SID;
const ANI_TWILIO_AUTH_TOKEN = TEST_TWILIO_AUTH_TOKEN;
const ANI_TWILIO_NUMBER = TEST_TWILIO_NUMBER;
const ANI_STRIPE_PUBLIC_KEY = TEST_STRIPE_PUBLIC_KEY;
const ANI_IPROMOTER_API_KEY = TEST_IPROMOTER_API_KEY;
const ANI_IPROMOTER_UTAG = TEST_IPROMOTER_UTAG;
const ANI_AWS_PUBLIC_KEY =  TEST_AWS_PUBLIC_KEY;
const ANI_AWS_SECRET_KEY = TEST_AWS_SECRET_KEY;
const ANI_AWS_BUCKET = TEST_AWS_BUCKET;
...
if (status == 'production') {
	...
	exports.IPROMOTER_API_KEY = ANI_IPROMOTER_API_KEY;
	exports.IPROMOTER_UTAG = ANI_IPROMOTER_UTAG;
	exports.AWS_PUBLIC_KEY = ANI_AWS_PUBLIC_KEY;
	exports.AWS_SECRET_KEY = ANI_AWS_SECRET_KEY;
	exports.AWS_BUCKET = ANI_AWS_BUCKET;
}
