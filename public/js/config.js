...
var PRODUCTION_LUIS_ID = "0a8ae437-0ff1-44c4-af7c-cc94fd0baf11";
var PRODUCTION_LUIS_SUBSCRIPTION_KEY = "a87263ffb22f4feb9a89aea610608ca7";
var PRODUCTION_ROOT_URL = "https://limitless-sierra-68694.herokuapp.com"
var PRODUCTION_TWILIO_ACCOUNT_SID = "ACc456f2ee8565e5af8c02a6357e4a9a9e";
var PRODUCTION_TWILIO_AUTH_TOKEN = "57357afaccfe2a344c5cd54fb74f725c";
var PRODUCTION_TWILIO_NUMBER = "+441273917139";
...
var TEST_TWILIO_ACCOUNT_SID = "ACc456f2ee8565e5af8c02a6357e4a9a9e";
var TEST_TWILIO_AUTH_TOKEN = "57357afaccfe2a344c5cd54fb74f725c";
var TEST_TWILIO_NUMBER = "+441273917139";
...
if (status == 'production') {
	...
	var LUIS_ID = PRODUCTION_LUIS_ID;
	var LUIS_SUBSCRIPTION_KEY = PRODUCTION_LUIS_SUBSCRIPTION_KEY;
	var ROOT_URL = PRODUCTION_ROOT_URL;
	var TWILIO_ACCOUNT_SID = PRODUCTION_TWILIO_ACCOUNT_SID;
	var TWILIO_AUTH_TOKEN = PRODUCTION_TWILIO_AUTH_TOKEN;
	var TWILIO_NUMBER = PRODUCTION_TWILIO_NUMBER;
} else if (status == 'test') {
	...
	var TWILIO_ACCOUNT_SID = TEST_TWILIO_ACCOUNT_SID;
	var TWILIO_AUTH_TOKEN = TEST_TWILIO_AUTH_TOKEN;
	var TWILIO_NUMBER = TEST_TWILIO_NUMBER;
} else if (status == 'avi') {
	...
	var TWILIO_ACCOUNT_SID = AVI_TWILIO_ACCOUNT_SID;
	var TWILIO_AUTH_TOKEN = AVI_TWILIO_AUTH_TOKEN;
	var TWILIO_NUMBER = AVI_TWILIO_NUMBER;
}
